<?php use_helper('a') ?>
<div id="a-media-embed-target" class="a-media-library-embed embed-closed">
  <div class="a-media-library-embed-inner clearfix">
  <h3><?php echo a_('Paste an embed code') ?></h3>
