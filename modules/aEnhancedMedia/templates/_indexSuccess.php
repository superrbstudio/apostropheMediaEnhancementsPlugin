...
<div class="a-media-library clearfix">
  ...
  <?php include_component('aEnhancedMedia', 'mediaAlerts') ?>
...
<?php include_component('aEnhancedMedia', 'browser', array('uploadAllowed' => $uploadAllowed, 'embedAllowed' => $embedAllowed)) ?>
